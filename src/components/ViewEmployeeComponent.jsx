                        ...
                        <div className="row">
                                ...
                                <div className="col-7">
                                        ...
                                        <div className = "row">
                                            ...
                                            <div className='ml-2'> { this.state.employee.patientName }</div>
                                        </div>
                                        <div className = "row">
                                            <label>Doctor Name : </label>
                                            <div className='ml-2'> { this.state.employee.doctorName }</div>
                                        </div>
                                        <div className = "row">
                                            <label>Disease: </label>
                                            <div className='ml-2'> { this.state.employee.disease }</div>
                                        </div>

                                        <div className = "row">
                                            <label>Room No </label>
                                            <div className='ml-2'> { this.state.employee.roomNo }</div>
                                        </div>
                                </div>
                        </div>
